...
class Button():
    def __init__(self, surface: pygame.Surface, rect: pygame.Rect, color: pygame.Color, text: str, fontSize: int = 60, borderRadius: int = 20) -> None:
    ...
    def createButton(self):
        button_rect = pygame.draw.rect(
            self.surface, self.color, self.rect, border_radius=self.borderRadius)
